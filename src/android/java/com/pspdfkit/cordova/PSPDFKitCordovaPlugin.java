...
public class PSPDFKitCordovaPlugin extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext)
    ...
    // TODO: We should simplify the plugin and remove this method in favor of android_assets:///
    //  URIs.
    else if (action.equals("showDocumentFromAssets")) {
      this.showDocumentFromAssets(
          args.getString(ARG_DOCUMENT_URI), password, configuration, callbackContext);
      return true;
    }
  ...
  private EnumSet<ShareFeatures> parseShareFeatures(@Nullable JSONArray shareFeatures)
      throws JSONException {
   ...
   * @param callbackContext Cordova callback.
   */
  private void showDocumentFromAssets(
